    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.post("".concat(API_URL, "/login"), { nickname: nickname })];
                case 1:
                    response = _a.sent();
                    if (response.data.success) {
                        console.log("Login bem-sucedido! Plano: ".concat(response.data.plan));
                        return [2 /*return*/, response.data.plan];
                    }
                    else {
                        console.error(response.data.message);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.post("".concat(API_URL, "/horoscope"), { nickname: nickname, sign: sign })];
                case 1:
                    response = _a.sent();
                    if (response.data.success) {
